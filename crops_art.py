...
def seed_scatter(name, big, small, alt=False):
    """Standard seed-item scatter; two layouts, recolored per seed type."""
    a = [
        "................",
        "................",
        "................",
    ...
    rows = [r.replace("1", big).replace("2", small) for r in (b if alt else a)]
    sprite(name, rows)


seed_scatter("item/leek_seeds", "g", "d", alt=True)
seed_scatter("item/barley_seeds", "A", "y", alt=True)
seed_scatter("item/rye_seeds", "B", "T")
seed_scatter("item/oat_seeds", "T", "y", alt=True)
seed_scatter("item/radish_seeds", "a", "R")
seed_scatter("item/parsnip_seeds", "w", "T", alt=True)
seed_scatter("item/pepper_seeds", "Y", "w")
seed_scatter("item/flax_seeds", "b", "B", alt=True)
seed_scatter("item/squash_seeds", "w", "y")
